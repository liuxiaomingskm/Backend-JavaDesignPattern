package com.example.flyweight.textFormatting;
...
/**
 * Summary：
 * We can also use String.intern() to save the memory. The usage of this method is as followed:
 *
 * String interning is a method of storing one copy of each distinct String Value, which must be immutable.
 * By applying String.intern() on a couple of strings will ensure that all strings having the same content share the same
 * memory.
 */
